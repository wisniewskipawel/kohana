	...
	<div id="categories_box" class="box collapse">
		...
		<div class="box-content">
			<nav id="categories_nav">
				<?php echo View::factory('layouts/products/partials/categories')
					->set('categories', ORM::factory('Product_Category')->get_categories_list())
					->render() ?>
			</nav>
		</div>
	</div>
...
<?php if(Products::config('provinces_enabled')) echo Widget_Box::factory('regions/map', array(
	'route' => Route::get('site_products/frontend/products/index'),
))->render() ?>
