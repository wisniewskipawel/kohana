<div id="product_box_pre_add" class="box primary products">
	<h2><?php echo $document->document_title ?></h2>
	<div class="content">
		<div class="pre_add_left">
			<?php echo $document->document_content ?>
			<a class="button center" href="<?php echo Route::url('site_products/frontend/products/add') ?>"><?php echo ___('products.pre_add.add_btn') ?></a>
		</div>
