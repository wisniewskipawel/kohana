...
*/
class Form_Admin_Offer_Add extends Bform_Form {
	...
	public function create(array $params = array())
	{
		...
		$this->add_select('offer_distinction', offers::distinctions(TRUE), array());
		
		$this->add_datetime('offer_promotion_availability', array('required' => FALSE));
