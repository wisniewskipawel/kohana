...
class Form_Profile_Catalog_Company_Edit extends Bform_Form {
	...
	public function  create(array $params = array()) 
	{
		...
		if($company->get_promotion_type_limit('products'))
		{
		...
		if($company->get_promotion_type_limit('hours'))
		{
			$this->add_company_hours('company_hours', array('required' => FALSE));
		}
		
		if($company->get_promotion_type_limit('keywords'))
		{
		...
		$amount_photos = $company->get_promotion_type_limit('images') - count($params['images']);
