...
class Form_Admin_Catalog_Company_Add extends Bform_Form 
{
	public function  create(array $params = array()) 
	{
		...
		$this->add_input_hidden('company_is_approved', 1);
		...
		$this->add_file_uploader('photos', array('amount' => 7, 'type' => 'images', 'label' => 'images.add'));
