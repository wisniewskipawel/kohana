...
*/
class Form_Admin_Admins_Edit extends Form_Admin_Admins_Add {
	...
	{    
		...
		$this->add_input_text('user_name')
			->add_validator('user_name', 'Bform_Validator_Auth_Username', array('edit' => TRUE, 'user_id' => $user->pk()));
		
		$this->add_input_email('user_email')
			->add_validator('user_email', 'Bform_Validator_Auth_Email', array('edit' => TRUE, 'user_id' => $user->pk()));
