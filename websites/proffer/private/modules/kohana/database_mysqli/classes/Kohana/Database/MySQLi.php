...
class Kohana_Database_MySQLi extends Database {
	...
	public function connect()
	{
		...
		catch (ErrorException $e)
		{
					...
					':error' => $this->_connection->connect_error,
                        ...
                        {
                                throw new Database_Exception('Can\'t connect to database.');
                        }
	...
	public function multi_query($type, $sql, $as_object = FALSE, array $params = NULL)
	{
		// Make sure the database is connected
		$this->_connection or $this->connect();
        ...
        if ($this->_connection->multi_query($sql))
        {
            do
            {
                $result = $this->_connection->next_result();
                
                $wtf = $this->_connection->store_result();
