<?php
/**
 * Template Name: Resumes Pricing - Style 3
 *
 * @package PetSitter
 * @since PetSitter 1.2
 */
...
get_header(); ?>
	...
	<div class="page-content woocommerce-page">
		<div class="container">
			<div class="wc-job-packages wc-job-packages__style3">
				...
				<div class="row">
					...
					<?php while ( $packages->have_posts() ) : $packages->the_post(); $package = get_product( get_post()->ID ); ?>
						...
						<div class="<?php echo $table_col; ?>">
							<div class="pricing-table pricing-table__style3 woocommerce <?php echo $table_style; ?>">
